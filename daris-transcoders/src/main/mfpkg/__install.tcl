...
# Default dicom to nifto transcoder
...
plugin.module.add :path $plugin_path :class $module_class :config -name DICOMTranscoder "\"${dicom.trans}\"" :config -name JavaXmxOption "\"${JavaXmxOption}\"" :lib libs/nig-commons.jar :lib libs/dcmtools.jar :lib libs/loni-debabeler.jar
