...
# description: creates a user in the specified authentication domain.
# ============================================================================
proc createUser { domain user } {
        user.create :domain ${domain} :user ${user}
}
...
#       internal - set to true if they are internal users. defaults to false.
#                  (optional).
# description: creates a list of users in the specified authentication domain.
# ============================================================================
proc createUsers { domain users {internal 0} } {

    foreach user $users {
        createUser $domain $user $internal
    }
