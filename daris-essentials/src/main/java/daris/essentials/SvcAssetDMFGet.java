...
public class SvcAssetDMFGet extends PluginService {

	public static final String CMD_DMGET = "dmget";
	private Interface _defn;

	public SvcAssetDMFGet() {
	...
	public String name() {
		...
		return "nig.asset.dmget";

	}

	public String description() {

		return "Make the contents of the specified local object (and its descendants online) if they are stored in a SGI DMF system.";
	...
	public void execute(XmlDoc.Element args, Inputs in, Outputs out, XmlWriter w) throws Throwable {
		...
		if (cid == null) {
			if (async) {
				...
				if (url != null) {
					Exec.exec(new String[] { CMD_DMGET, url });
				}
			}
		} else {
			String query;
