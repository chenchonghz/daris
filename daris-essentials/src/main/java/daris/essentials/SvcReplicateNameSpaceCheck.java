...
public class SvcReplicateNameSpaceCheck extends PluginService {
	...
	public SvcReplicateNameSpaceCheck() {
		...
		_defn.add(new Interface.Element("dst", StringType.DEFAULT, "The destination parent namespace that assets will be replicated to (use '/' for root namespace). Our convention is to use the UUID of the primary server.", 1, 1));
