...
public class DicomElements {
	...
	public static final String DICOM_MODALITY_DICTIONARY = "daris:pssd.dicom.modality";

	public static final DataElementTag IMAGE_TYPE = new DataElementTag(0x0008,0x0008);
