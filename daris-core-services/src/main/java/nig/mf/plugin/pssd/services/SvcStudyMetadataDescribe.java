...
public class SvcStudyMetadataDescribe extends PluginService {
	...
	public String description() {
		return "Describes the metadata that can be associated with a Study.  It combines any data registered with the data model as well as that specified by the given ExMethod.  In a federation, fetches the meta-data from the server that manages the Project.";
	}
