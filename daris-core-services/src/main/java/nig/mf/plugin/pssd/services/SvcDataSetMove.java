...
public class SvcDataSetMove extends PluginService {
    ...
    public void execute(XmlDoc.Element args, Inputs in, Outputs out, XmlWriter w) throws Throwable {
		...
		// Set distributed citeable ID for the DataSet to move. The DataSet is
        // local by definition
        ...
        // We don't want the DataSet we are moving to have children on a remote
        // server. This
        ...
        if (dDSID.hasRemoteChildren(ResultAssetType.primary, ptag, pdist)) {
            throw new Exception(
                    "The supplied DataSet has primary children on remote servers in the federation; cannot move it.");
        }
