...
public class SvcProjectMembersRemove extends PluginService {
    ...
    public SvcProjectMembersRemove() {
        ...
        Interface.Element me = new Interface.Element("member", XmlDocType.DEFAULT,
                "User member to remove from this Project.", 0, Integer.MAX_VALUE);
        //
        ...
        // Project team role-members. Although I could drop the upper level,
        // leave it
        // like this for consistency with all other interfaces.
        me = new Interface.Element("role-member", XmlDocType.DEFAULT, "The role-member to remove from this Project.",
                0, Integer.MAX_VALUE);
        me.add(new Interface.Element("member", StringType.DEFAULT, "The role member.", 1, 1));
        _defn.add(me);
            ...
            for (XmlDoc.Element member : members) {
                ...
                if (projectRole != null) {
                    ...
                    if (projectRole != null) {
                        ...
                        if (projectRole.equals(Project.ADMINISTRATOR_ROLE_NAME))
                            nAdmin--;
                    }
    ...
    private void checkAdmins(Integer nProjectAdmin, String role, String member, String projectCid) throws Throwable {
        if (nProjectAdmin == 1 && role.equals(Project.ADMINISTRATOR_ROLE_NAME)) {
            throw new Exception("Member '" + member + "' is the last Project Admin for project '" + projectCid
                    + "'. Cannot remove.");
        }
    }
