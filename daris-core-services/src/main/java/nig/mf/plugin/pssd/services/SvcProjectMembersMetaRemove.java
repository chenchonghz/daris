...
public class SvcProjectMembersMetaRemove extends PluginService {
	...
	public String description() {
		return "Remove the daris:pssd-project/{member,role-member} meta-data. This is a service function to be run once in the transition to fully role-based project member management.";
	}
	...
	public void execute(XmlDoc.Element args, Inputs in, Outputs out, XmlWriter w) throws Throwable {
		...
		if (!ModelUser.checkHasRoleNoThrow(null, executor(), Role.objectAdminRoleName())) {
	...
	private void remove (ServiceExecutor executor, String id, XmlWriter w) throws Throwable {
		...
		if (r==null) return;
		//
		XmlDoc.Element pssdProject= r.element("asset/meta/daris:pssd-project");
