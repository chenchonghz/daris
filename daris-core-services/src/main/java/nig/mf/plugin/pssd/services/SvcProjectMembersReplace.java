                ...
                try {
                    ...
                    if (!ignoreSystem || (ignoreSystem && !domain.equalsIgnoreCase("system"))) {
                        ...
                        UserCredential userCred = new UserCredential(member.value("authority"),
                                member.value("authority/@protocol"), domain, member.value("user"));
        ...
        if (roleMembers != null) {
            for (XmlDoc.Element member : roleMembers) {
                ...
                try {
                    ...
                    // registry.
                    Boolean checkTopName = false; // The element name is
                                                  // 'member' but in the
                                                  // registry it's 'role'
        ...
        if (memberFailedOn != null) {
            ...
            for (XmlDoc.Element member : doneMembers) {
                ...
                if (name.equals("member")) {
                    ...
                    UserCredential userCred = new UserCredential(member.value("@authority"), member.value("@protocol"),
                            member.value("@domain"), member.value("@user"));
