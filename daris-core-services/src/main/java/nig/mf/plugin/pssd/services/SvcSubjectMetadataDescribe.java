...
public class SvcSubjectMetadataDescribe extends PluginService {
	...
	public String description() {
		return "Describes the metadata that can be associated with the creation of a Subject object. It combines any data registered with the data model as well as that specified by the given Method.  In a federation, fetches the meta-data from the server that manages the Project.";
	}
