...
public class SvcRSubjectCreate extends PluginService {
	...
	public static TemplateDefinitions subjectTemplate(ServiceExecutor executor,String mid) throws Throwable {
		...
		tds.identityTemplate = r.element("asset/meta/daris:pssd-method-rsubject/identity");
		tds.publicTemplate = r.element("asset/meta/daris:pssd-method-rsubject/public");
		tds.privateTemplate = r.element("asset/meta/daris:pssd-method-rsubject/private");
	...
	public static class ServiceOp implements AtomicOperation {
		...
		public boolean execute(ServiceExecutor executor) throws Throwable {
			...
			String pdist = null;
			String proute = null;
			String cidRoot = nig.mf.pssd.plugin.util.CiteableIdUtil.citeableIDRoot(executor, proute, nig.mf.pssd.CiteableIdUtil.RSUBJECT_ID_ROOT_NAME);
			_cid = nig.mf.pssd.plugin.util.CiteableIdUtil.createCid(executor, cidRoot, pdist);
		...
		*/
		...
		private void createSubjectAsset(ServiceExecutor executor,XmlDoc.Element args, String cid,TemplateDefinitions tds) throws Throwable {
			...
			dm.push("meta");
			PSSDUtils.setObjectMeta(dm, RSubject.TYPE, args.value("name"), args.value("description"), true);
