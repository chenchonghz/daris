...
public class StudyProxyFactory {
    ...
    private static StudyProxy createPSSDStudy(ServiceExecutor executor,
        ...
        System.out.println("StudyProxyFactory::createPSSDStudy:  cid_step = "
                + cms.toString());
        ...
        // exception
        try {
            nig.mf.pssd.plugin.util.CiteableIdUtil
                    .checkCIDIsForThisServer(executor, cid, true);
        } catch (Throwable t) {
        ...
        try {
            ...
            if (pssdType.equals("project")) {
                if (ic.autoSubjectCreate()) {
                    ...
                    // project. We can use DICOM mf-dicom-patient
            ...
            // Stick on the standard mf-dicom-patient meta-data in private. We
            // do this
