...
public class SvcProjectUpdate extends PluginService {
    ...
    public SvcProjectUpdate() {
        ...
        _defn.add(new Interface.Element("allow-invalid-meta", BooleanType.DEFAULT,
                "Should the metadata be accepted if invalid? Defaults to false.", 0, 1));
    ...
    public static void updateProjectAsset(ServiceExecutor executor, XmlDoc.Element args, String cid) throws Throwable {
        ...
        dm.add("allow-invalid-meta", args.booleanValue("allow-invalid-meta", false));
        ...
        // Common object stuff in meta/daris:pssd-object
        PSSDUtils.setObjectMeta(dm, Project.TYPE, args.value("name"), args.value("description"), false);
        ...
        String currentDataUse = r.value("asset/meta/daris:pssd-project/data-use");
