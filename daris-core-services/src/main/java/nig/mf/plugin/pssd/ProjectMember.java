...
public class ProjectMember {
	...
	private void findProjects(XmlDoc.Element r, HashMap<String, String> map) throws Throwable {
		...
		for (XmlDoc.Element e : children) {
			...
			if (name.equals("role")) {
				...
				String role = e.value();
				ProjectRoleSplit pr = new ProjectRoleSplit(role);
				//
	 ...
	 * @return
	 */
	private boolean hasHigher(HashMap<String, String> map, ProjectRoleSplit pr) {
		...
		if (pr.genericRole().equals(Project.ADMINISTRATOR_ROLE_NAME)) {
			...
			String higherRole = ProjectRole.SUBJECT_ADMINISTRATOR_ROLE_PREFIX + "." + pr.cid();
			...
			if (map.containsKey(higherRole))
				return true;
			//
			higherRole = ProjectRole.SUBJECT_ADMINISTRATOR_ROLE_PREFIX + "." + pr.cid();
			if (map.containsKey(higherRole))
				return true;
			...
			if (map.containsKey(higherRole))
				return true;
			//
			higherRole = ProjectRole.MEMBER_ROLE_PREFIX + "." + pr.cid();
			if (map.containsKey(higherRole))
				return true;
		}
		return false;
	...
	private String hasLower(HashMap<String, String> map, ProjectRoleSplit pr) {
		...
		if (pr.genericRole().equals(Project.ADMINISTRATOR_ROLE_NAME)) {
			String lowerRole = ProjectRole.SUBJECT_ADMINISTRATOR_ROLE_PREFIX + "." + pr.cid();
			if (map.containsKey(lowerRole))
				return lowerRole;
			//
			lowerRole = ProjectRole.MEMBER_ROLE_PREFIX + "." + pr.cid();
			if (map.containsKey(lowerRole))
				return lowerRole;
			//
			lowerRole = ProjectRole.GUEST_ROLE_PREFIX + "." + pr.cid();
			if (map.containsKey(lowerRole))
				return lowerRole;
		} else if (pr.genericRole().equals(Project.SUBJECT_ADMINISTRATOR_ROLE_NAME)) {
			String lowerRole = ProjectRole.MEMBER_ROLE_PREFIX + "." + pr.cid();
			if (map.containsKey(lowerRole))
				return lowerRole;
			//
			lowerRole = ProjectRole.GUEST_ROLE_PREFIX + "." + pr.cid();
			...
			String lowerRole = ProjectRole.GUEST_ROLE_PREFIX + "." + pr.cid();
			if (map.containsKey(lowerRole))
				return lowerRole;
		} else if (pr.genericRole().equals(Project.GUEST_ROLE_NAME)) {
