...
public class SvcObjectDescribe extends PluginService {
	...
	public SvcObjectDescribe() {
		...
		me = new Interface.Element(
				...
				0, 1);
		me.add(new Interface.Attribute("descend", BooleanType.DEFAULT,
				"Controls whether locks should also be acquired for all descendants. The default is set to true.", 0));
		me.add(new Interface.Attribute(
				"timeout",
				IntegerType.DEFAULT,
