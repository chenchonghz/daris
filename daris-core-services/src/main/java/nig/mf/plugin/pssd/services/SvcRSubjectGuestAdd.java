...
public class SvcRSubjectGuestAdd extends PluginService {
	...
	public String name() {
		return "om.pssd.r-subject.guest.add";
	}

	public String description() {
		return "Assign the ability to view and therefore search for subjects to a project's RSubject administrators.";
	}
