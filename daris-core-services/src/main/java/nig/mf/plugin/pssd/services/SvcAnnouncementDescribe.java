...
public class SvcAnnouncementDescribe extends PluginService {

    private Interface _defn;

    public SvcAnnouncementDescribe() {
        _defn = new Interface();
    ...
    public String description() {
        return "describes the specified system announcement.";
    }
    ...
    public void execute(Element args, Inputs arg1, Outputs arg2, XmlWriter w)
        ...
        Announcement a = Announcement.get(executor(), uid);
        if (a == null) {
            throw new Exception("Announcement " + uid + " does not exist.");
        }
        a.describe(w);
    }
