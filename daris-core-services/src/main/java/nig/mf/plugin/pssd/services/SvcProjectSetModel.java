...
/**
 * Service to recursively set the data model in a project tree. Currently only
 * allowed to modify local objects as this is the current federation policy.
 * This could be relaxed, but the use case is from an archive and local restore.
 * 
...
public class SvcProjectSetModel extends PluginService {
    ...
    public void execute(XmlDoc.Element args, Inputs in, Outputs out, XmlWriter w) throws Throwable {
        ...
        // Validate project CID. Can be primary or replica as this is a service
        // function
