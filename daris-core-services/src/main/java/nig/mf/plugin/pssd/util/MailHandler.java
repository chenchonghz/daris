 ...
 * directly supplied 4) The daris:pssd-notifications meta-data, if set on a Project
...
public class MailHandler {
	 ...
	 * 
	 * @param forDataUpload
	 *            If true, looks at the 'data-upload' part of daris:pssd-notification.
	...
	private void addStandardNotificationUsers (XmlDoc.Element du) throws Throwable {
		if (du == null)
			return;
