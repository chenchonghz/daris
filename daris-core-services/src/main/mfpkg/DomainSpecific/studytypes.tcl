...
# could be changed to something more extensible). This list is clearly specific to bio-medical imaging
# and is derived originally partly from the DICOM modalities.
#
proc create_DomainStudyTypes { } {
