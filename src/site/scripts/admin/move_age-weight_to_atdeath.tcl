########################################################################################################################################
# Move nig-daris:pssd-animal-subject/age to age-at-death
# Move nig-daris:pssd-animal-subject/weight to weight-at-death
#
# 1. Modify the nig-daris:pssd-animal-subject Document Type so that it contains both
...
# 3. Modify the  nig-daris:pssd-animal-subject Document Type so that it ontains only
...
doIt "nig-daris:pssd-animal-subject" "age" "age-at-death"
doIt "nig-daris:pssd-animal-subject" "weight" "weight-at-death"
