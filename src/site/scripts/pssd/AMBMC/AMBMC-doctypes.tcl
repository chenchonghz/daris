...
proc createDocType-pssd-AMBMC-brain-removal  {} {
        asset.doc.type.update \
           :create true :type nig-daris:pssd-AMBMC-brain-removal  \
...
proc destroyDocType-pssd-AMBMC-brain-removal { force } {
    ...
    if { [xvalue exists [asset.doc.type.exists :type nig-daris:pssd-AMBMC-brain-removal]] == "true" } {
                asset.doc.type.destroy :type nig-daris:pssd-AMBMC-brain-removal :force $force
    }
}
