...
public class CiteableIdUtils {
    ...
    public static DObject.Type getChildTypeFromCID(String cid) {
    ...
    public static DObject.Type getTypeFromCID(String cid) {

        int depth = getDepth(cid);
        return getTypeFromDepth(depth);
    }

    public static DObject.Type getTypeFromDepth(int depth) {
    ...
    public static String getTypeNameFromCID(String cid) {
        DObject.Type type = getTypeFromCID(cid);
