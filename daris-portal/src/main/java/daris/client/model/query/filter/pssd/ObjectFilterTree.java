...
public class ObjectFilterTree extends FilterTree {
    ...
    public ObjectFilterTree(DObjectRef project) {
        ...
        super(
                new FilterEntry[] {
                        new FilterEntry("composite", new ObjectCompositeFilter(project, null),
                                "Composite filter (drag to filter pane on left)"),

                        new FilterEntry("metadata", new ObjectMetadataFilter(project, null, null,
                                null, null, false), "Object metadata filter (drag to filter pane on left)"),

                        new FilterEntry("tag", new ObjectTagFilter(project, null, null),
                                "Object tag filter (drag to filter pane on left)"),

                        new FilterEntry("text", new TextFilter(null, null, null), "Text filter (drag to filter pane on left)"),

                        new FilterEntry("asset/acl", new ACLFilter(ACLOperator.FOR_ROLE, null),
                                "Asset ACL filter (drag to filter pane on left)"),

                        new FilterEntry("asset/cid", new CIDFilter(), "Asset CID filter (drag to filter pane on left)"),

                        new FilterEntry("asset/type", new TypeFilter(), "Asset MIME type filter (drag to filter pane on left) "),
                        ...
                        new FilterEntry("asset/property", new AssetFilter(null, null),
                        ...
                        new FilterEntry("dicom/series/protocol", new SeriesProtocolFilter(),
