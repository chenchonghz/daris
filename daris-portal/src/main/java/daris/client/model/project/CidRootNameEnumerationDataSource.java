...
public class CidRootNameEnumerationDataSource implements DynamicEnumerationDataSource<String> {

    private String _dict;

    public CidRootNameEnumerationDataSource() {
        _dict = Project.CID_ROOT_NAME_DICTIONARY;
    }
