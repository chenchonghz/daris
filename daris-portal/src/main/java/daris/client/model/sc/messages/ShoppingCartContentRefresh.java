...
public class ShoppingCartContentRefresh extends ObjectMessage<Null> {

    public static final String SERVICE_NAME = "shopping.cart.content.refresh";

    private ShoppingCartRef _cart;

    public ShoppingCartContentRefresh(ShoppingCartRef cart) {
        _cart = cart;
    }
