...
public class ProjectDetails extends DObjectDetails {
	...
	protected void insertToInterfaceTab(VerticalPanel vp) {
		...
		// nsHP.setSpacing(8);
		//
		// TreeSelectComboBox<NamespaceRef> nsCombo = new
		// TreeSelectComboBox<NamespaceRef>(new NamespaceRef(
		// po.namespace() == null ? Project.DEFAULT_PROJECT_NAMESPACE :
		// po.namespace()), new NamespaceTree(),
		// true) {
		//
		// @Override
