...
public class ProjectMemberRoleSelector {
    ...
    private ProjectMemberRoleSelector(final int x, final int y, int width, int height, final RoleSelectionListener rsl) {

        VerticalPanel vp = new VerticalPanel();
        vp.setBorderRadius(3);
        vp.setBoxShadow(1, 1, 5, 5, new RGBA(0, 0, 0, 0.2));
        vp.fitToParent();
        ...
        header.setBackgroundImage(new LinearGradient(LinearGradient.Orientation.TOP_TO_BOTTOM,
                new RGB(0xcd, 0xcd, 0xcd), new RGB(0x97, 0x97, 0x97)));
        ...
        final Form form = new Form() {
            ...
            public Validity valid() {
                ...
                if ((_role.equals(ProjectRole.MEMBER) || _role.equals(ProjectRole.GUEST)) && _dataUse == null) {
                    return new Validity() {
                        @Override
        ...
        form.fitToParent();
        Field<ProjectRole> roleField = new Field<ProjectRole>(new FieldDefinition("Role",
                ProjectRole.asEnumerationType(), "Project role", null, 1, 1));
        ...
        _pp.setBackgroundColour(new RGB(0xf0,0xf0,0xf0));
        _pp.setBorder(1, new RGB(0xa0,0xa0, 0x80));
        _pp.setContent(vp);
    ...
    public static void showAt(int x, int y, int width, int height, RoleSelectionListener rsl) {
