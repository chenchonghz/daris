...
public class DicomSendForm extends ValidatedInterfaceComponent
    ...
    private static enum ElementAction {
        NONE("none"), ANONYMIZE("anonymize"), SET_VALUE(
                "set value"), SET_VALUE_TO_SUBJECT_CID(
                        "set value to subject.cid"), SET_VALUE_TO_STUDY_CID(
                                "set value to study.cid"), SET_VALUE_TO_PATIENT_NAME(
                                        "set value to patient.name"), SET_VALUE_TO_PATIENT_ID(
                                                "set value to patient.id");
    ...
    private DicomSendForm(DicomSend ds) {
        ...
        if (_ds.cid() != null) {
            Field<String> rootIdField = new Field<String>(
                    new FieldDefinition("Root", ConstantType.DEFAULT,
            ...
            Field<String> whereField = new Field<String>(
                    new FieldDefinition("Root Query", TextType.DEFAULT,
        ...
        FieldGroup callingAEFieldGroup = new FieldGroup(
                new FieldDefinition("Calling Application Entity",
                        DocType.DEFAULT, null, null, 1, 1));
        final Field<String> callingAETitleField = new Field<String>(
                new FieldDefinition("AE Title",
                        new EnumerationType<String>(
                                new LocalAETitleEnumDataSource()),
                        null, null, 1, 1));
        callingAETitleField
                .setRenderOptions(new FieldRenderOptions().setWidth(0.6));
        ...
        FieldGroup calledAEFieldGroup = new FieldGroup(
                new FieldDefinition("Called Application Entity",
                        DocType.DEFAULT, null, null, 1, 1));
        Field<DicomAE> calledAESelectField = new Field<DicomAE>(
                new FieldDefinition("Select AE",
                        new EnumerationType<DicomAE>(
                                new DicomAEEnum(DicomAEList.Type.REMOTE,
                                        DicomAEList.Access.ALL)),
                        null, null, 0, 1));
        calledAESelectField
                .setRenderOptions(new FieldRenderOptions().setWidth(0.6));
        ...
        FieldGroup overrideFieldGroup = new FieldGroup(
                new FieldDefinition("Override", DocType.DEFAULT,
                        "Override DICOM header elements.", null, 1, 1));
        // Patient Name
        FieldGroup patientNameFG = new FieldGroup(
                new FieldDefinition("Patient Name", DocType.DEFAULT,
        ...
        Field<ElementAction> patientNameAction = new Field<ElementAction>(
                new FieldDefinition("Action",
                        new EnumerationType<ElementAction>(
                                ElementAction.values()),
                        null, null, 0, 1));
        patientNameAction.setInitialValue(ElementAction.ANONYMIZE, false);
        ...
        patientNameFG.addListener(new DicomElementChangeListener() {
            ...
            public void elementChanged(ElementAction action, String value) {
                ...
                case SET_VALUE_TO_SUBJECT_CID:
                    _ds.setElement(ElementName.PATIENT_NAME,
                            ValueReference.SUBJECT_CID);
                    break;
                case SET_VALUE_TO_STUDY_CID:
                    _ds.setElement(ElementName.PATIENT_NAME,
                            ValueReference.STUDY_CID);
                    break;
                case SET_VALUE_TO_PATIENT_NAME:
                    _ds.setElement(ElementName.PATIENT_NAME,
                            ValueReference.PATIENT_NAME);
                    break;
                case SET_VALUE_TO_PATIENT_ID:
                    _ds.setElement(ElementName.PATIENT_NAME,
                            ValueReference.PATIENT_ID);
                    break;
                default:
                    break;
                }
        ...
        FieldGroup patientIdFG = new FieldGroup(
                new FieldDefinition("Patient ID", DocType.DEFAULT,
        ...
        patientIdFG.addListener(new DicomElementChangeListener() {
            ...
            public void elementChanged(ElementAction action, String value) {
                ...
                case SET_VALUE:
                    ...
                    break;
                case SET_VALUE_TO_SUBJECT_CID:
                    _ds.setElement(ElementName.PATIENT_ID,
                            ValueReference.SUBJECT_CID);
                    break;
                case SET_VALUE_TO_STUDY_CID:
                    _ds.setElement(ElementName.PATIENT_ID,
        ...
        FieldGroup studyIdFG = new FieldGroup(
                new FieldDefinition("Study ID", DocType.DEFAULT,
                        "The study id element(0020,0010).", null, 0, 1));
        ...
        studyIdFG.addListener(new DicomElementChangeListener() {
            ...
            public void elementChanged(ElementAction action, String value) {
                ...
                case SET_VALUE:
                    ...
                    break;
                case SET_VALUE_TO_SUBJECT_CID:
                    _ds.setElement(ElementName.STUDY_ID,
                            ValueReference.SUBJECT_CID);
                    break;
                case SET_VALUE_TO_STUDY_CID:
                    _ds.setElement(ElementName.STUDY_ID,
        ...
        Field<ElementAction> performingPhysicianNameAction = new Field<ElementAction>(
                new FieldDefinition("Action",
                        new EnumerationType<ElementAction>(
                                ElementAction.values()),
                        null, null, 0, 1));
        performingPhysicianNameAction.setInitialValue(ElementAction.NONE,
                false);
        ...
        performingPhysicianNameFG.addListener(new DicomElementChangeListener() {
            ...
            public void elementChanged(ElementAction action, String value) {
                ...
                case ANONYMIZE:
                    ...
                    break;
                case SET_VALUE:
                    _ds.setElement(ElementName.PERFORMING_PHYSICIAN_NAME,
                            value);
                    break;
                case SET_VALUE_TO_SUBJECT_CID:
                    _ds.setElement(ElementName.PERFORMING_PHYSICIAN_NAME,
        ...
        FieldGroup referringPhysicianNameFG = new FieldGroup(
                new FieldDefinition("Referring Physician Name", DocType.DEFAULT,
        ...
        referringPhysicianNameFG.addListener(new DicomElementChangeListener() {
            ...
            public void elementChanged(ElementAction action, String value) {
                ...
                case SET_VALUE:
                    ...
                    break;
                case SET_VALUE_TO_SUBJECT_CID:
                    _ds.setElement(ElementName.REFERRING_PHYSICIAN_NAME,
                            ValueReference.SUBJECT_CID);
                    break;
                case SET_VALUE_TO_STUDY_CID:
                    _ds.setElement(ElementName.REFERRING_PHYSICIAN_NAME,
        ...
        Field<ElementAction> referringPhysicianPhoneAction = new Field<ElementAction>(
                new FieldDefinition("Action",
                        new EnumerationType<ElementAction>(
                                ElementAction.values()),
                        null, null, 0, 1));
        referringPhysicianPhoneAction.setInitialValue(ElementAction.NONE,
                false);
        ...
        referringPhysicianPhoneFG.addListener(new DicomElementChangeListener() {
            ...
            public void elementChanged(ElementAction action, String value) {
                ...
                case ANONYMIZE:
                    ...
                    break;
                case SET_VALUE:
                    _ds.setElement(ElementName.REFERRING_PHYSICIAN_PHONE,
                            value);
                    break;
                case SET_VALUE_TO_SUBJECT_CID:
                    _ds.setElement(ElementName.REFERRING_PHYSICIAN_PHONE,
        ...
        FieldGroup genericElementFG = new FieldGroup(
                new FieldDefinition("DICOM Element", "element", DocType.DEFAULT,
        ...
        Field<String> geTag = new Field<String>(
                new FieldDefinition("Tag", "tag", new StringType(8, 8, 8),
                        "The DICOM element tag.", null, 0, 1));
    ...
    private static abstract class DicomElementChangeListener
            implements FieldSetListener {
        @Override
        public void addedField(FieldSet s, FormItem f, int idx,
                boolean lastUpdate) {
        }
