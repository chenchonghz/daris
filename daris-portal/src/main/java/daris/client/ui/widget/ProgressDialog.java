...
public class ProgressDialog {
	...
	public static final Colour PROGRESS_BAR_COLOR_LIGHT = new RGB(0x20,0x20,0xff);
	public static final Colour PROGRESS_BAR_COLOR_DARK = new RGB(0x70,0x70,0xc0);
	...
	public ProgressDialog(String title, String message, boolean autoClose,
		...
		_progressContainer.setBorder(1, new RGB(0x90,0x90,0x90));
		_progressContainer
				.setBackgroundImage(new LinearGradient(
						LinearGradient.Orientation.TOP_TO_BOTTOM, new RGB(0xf0,0xf0,0xf0),
						new RGB(0xe0,0xe0,0xe0)));
