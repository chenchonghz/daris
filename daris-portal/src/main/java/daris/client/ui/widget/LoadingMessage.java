...
public class LoadingMessage extends AbsolutePanel {
    ...
    public static final ImageResource LOADING_IMG_16 = Resource.INSTANCE.loading16();

    public static final ImageResource LOADING_IMG_100 = Resource.INSTANCE.loading100();
    ...
    public LoadingMessage(ImageResource loadingImage, String loadingMessage) {
        ...
        super();
        fitToParent();
        _loadingImg = new Image(loadingImage.getSafeUri().asString(), loadingImage.getWidth(), loadingImage.getHeight());
