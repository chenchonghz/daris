...
public class AttachmentAddForm extends ValidatedInterfaceComponent
    ...
    private Form createInterfaceForm() {
        ...
        Field<String> objectIdField = new Field<String>(
                new FieldDefinition("id",
                        ConstantType.DEFAULT, "The id of the "
                                + _o.referentTypeName() + " to attach to.",
                        null, 1, 1));
        objectIdField.setValue(_o.id());
        form.add(objectIdField);

        FieldGroup attachmentFieldGroup = new FieldGroup(new FieldDefinition(
                "attachment", DocType.DEFAULT, "The attachment.", null, 1, 1));

        _attachmentNameField = new Field<String>(new FieldDefinition("name",
                StringType.DEFAULT, "Name of the attachment.", null, 1, 1));
        ...
        Field<String> attachmentDescriptionField = new Field<String>(
                new FieldDefinition("description", TextType.DEFAULT,
                        "Description about the attachment.", null, 0, 1));
